...
int main() {
    ...
    //for (int i = 0; i < v2mok_kiekis; i++) {
    //    std::cout << gen_mok[i].galutinis << std::endl;
    //}
    ...
    //std::cout << gen_mok[0].Vardas << gen_mok[0].Pavarde << gen_mok[1].Egz << std::endl;
...
void gal_isvedimas(std::vector<mokinys>& gal_mok) {
    ...
    for (int i = 0; i < kiekis; i++) {
        ...
        for (int i = 0; i < kiekis; i++) {
            ...
            std::cout << gal_mok[idx].Pavarde << spacing(gal_mok[idx].Pavarde, 30);
            std::cout << gal_mok[idx].galutinis << spacing(std:: to_string(gal_mok[idx].galutinis), 19);
